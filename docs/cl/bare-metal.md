...
In this tutorial, we'll network boot and provision a Kubernetes v1.13.0-beta.1 cluster on bare-metal with Container Linux.
...
module "bare-metal-mercury" {
  source = "git::https://github.com/poseidon/typhoon//bare-metal/container-linux/kubernetes?ref=v1.13.0-beta.1"
...
```
# before v1.13.0-beta.1
$ ssh debug@node1.example.com
# after v1.13.0-beta.1
...
node1.example.com   Ready   controller,master  10m  v1.13.0-beta.1
node2.example.com   Ready   node               10m  v1.13.0-beta.1
node3.example.com   Ready   node               10m  v1.13.0-beta.1
```
