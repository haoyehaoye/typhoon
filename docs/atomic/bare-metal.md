...
In this tutorial, we'll network boot and provision a Kubernetes v1.13.0-beta.1 cluster on bare-metal with Fedora Atomic.
...
module "bare-metal-mercury" {
  source = "git::https://github.com/poseidon/typhoon//bare-metal/fedora-atomic/kubernetes?ref=v1.13.0-beta.1"
